...
const routes: Routes = [
  ...
  {
    path: 'tabmenunavigation',
    loadChildren: () => import('./component/tabmenu/tabmenunavigation/tabmenunavigation.module').then( m => m.TabmenunavigationPageModule)
  },
];
